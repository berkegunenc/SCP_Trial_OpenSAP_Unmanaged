...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zbg_s_rap_travel_u( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZBG_I_RAP_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZBG_I_RAP_TRAVEL_U IMPLEMENTATION.
