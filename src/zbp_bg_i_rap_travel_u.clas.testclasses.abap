...
CLASS ltcl_integration_test IMPLEMENTATION.
  ...
  METHOD create_travel.
    ...
    DATA travels_in TYPE TABLE FOR CREATE zbg_i_rap_travel_u\\travel.
    ...
    MODIFY ENTITIES OF zbg_i_rap_travel_u
      ENTITY travel
    ...
    SELECT * FROM zbg_i_rap_travel_u WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
  ...
  METHOD class_setup.
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
        i_for_entities = VALUE #( ( i_for_entity = 'zbg_i_rap_travel_u' )
                                ( i_for_entity = 'zbg_i_rap_booking_u' ) )
                              ).
  ENDMETHOD.
